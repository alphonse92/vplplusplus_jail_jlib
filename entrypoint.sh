...
echo 'Test script - Vpl ++ Jlib runner V.1.0.0' >> /usr/bin/vpl
echo 'UFPS' >> /usr/bin/vpl
...
echo 'Run Script - Vpl ++ Jlib runner V.1.0.0'  >> /usr/bin/vpl_run
echo 'UFPS'  >> /usr/bin/vpl_run
